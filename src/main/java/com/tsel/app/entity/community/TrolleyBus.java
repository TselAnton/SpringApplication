...
public class TrolleyBus extends AbstractPublicTransport {
    ...
    public TrolleyBus(String carNumber, String carModel, String color, Double averageSpeed, Double fuelPerKilometer, Integer numberOfSeats, Double costByTicket, String routeNumber, String routeStartTime, String routeEndTime, List<Integer> route, RouteService routeService) {
